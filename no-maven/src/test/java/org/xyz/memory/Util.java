...
public class Util {
  ...
  public static int getJavaMajorVersion(final String jdkVersion) {
  ...
  public static void writeReadAndPrintString(WritableMemory wmem, String str) {
    int len = str.length();
  ...
  public static void printMappedFile(Memory mem) {
  ...
  public static void println(Object obj) { System.out.println(obj.toString()); }
